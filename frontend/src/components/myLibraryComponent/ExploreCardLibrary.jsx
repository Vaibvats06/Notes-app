  ...
  return (
    <div className="flex flex-col   ">
      ...
      <div className="h-10 bg-red-50  rounded-b-2xl border-red-100 border-b-2 flex items-center justify-between">
        <button type="button" className="mx-2 px-2 rounded-lg border border-gray-400 bg-green-400 text-white hover:text-orange-600 transition-colors duration-200  cursor-pointer" onClick={handleDelete}>Delete</button>
